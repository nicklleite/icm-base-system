<div class="default-section users-wrapper">
    ...
    <div class="gc_filters_wrapper">
        <div class="row">
            <div class="col-lg-12">
                <?= form_open($action_filter, ['class' => 'gc_filters__user_search']) ?>
    ...
    <div class="gc_data_table table-responsive mt-3">
        <table class="table table-sm table-bordered">
            <thead>
                <tr class="text-center">
                    <th scope="col"><input class="form-control" type="checkbox" name="gc_data_table__select_all" id="gc_data_table__select_all" onchange="selectAll(this);return false;"></th>
            ...
            <tbody>
                <?php if (!empty($users)) : ?>
                    <?php foreach ($users as $row) : ?>
                        <tr>
                            <td><input class="form-control" type="checkbox" name="gc_data_table__select" id="gc_data_table__select_<?= $row->id ?>" data-userid="<?= $row->id ?>"></td>
                            <td><?= $row->fullname ?></td>
