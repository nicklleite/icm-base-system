...
class App extends BaseConfig
{
	...
	*/
	...
	| ClickSign
	|--------------------------------------------------------------------------
	| Habilita as requisições aos serviços disponíveis na API da ClickSign.
	| 
	| clickSignEnv = Ambiente em que as requisições serão feitas (sandbox|production)
	| clickSignApiVersion = Versão da API
	| clickSignToken = Token fornecido pela ClickSign
	| clickSignPdfLocalPath = Caminho onde o PDF será salvo
	| clickSignServices = Serviços disponíveis para uso na biblioteca
	|
	| Para mais informações:
	| 	- https://developers.clicksign.com/docs
	*/
	public $clickSignEnv = "";
	public $clickSignApiVersion = "";
	public $clickSignToken = "";
	public $clickSignPdfLocalPath = "";

	public $clickSignServices = [
		"document" => [
			"upload" => []
		]
	];
